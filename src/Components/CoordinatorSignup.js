...
import { CoordinatorRegSchema } from './Schema';
...
function CoordinatorSignup() {
    ...
    const onSubmit = (e) =>{
        // e.preventDefault();
          console.log('hi');
          axiosInstance.post('/coordinatorsRegistration',values)
          .then((res)=>{
        ...
        const { values, errors, touched, handleBlur, handleChange, handleSubmit } =
          useFormik({
              initialValues: {
                ...
                validationSchema: CoordinatorRegSchema,
                onSubmit,
    ...
    <div>
      ...
      <div class="container-fluid pt-5">
        <div class="d-flex flex-column text-center mb-5 pt-5">
            ...
            <h1 class="display-4 m-0">Coordinator <span class="text-primary">Signup</span></h1>
        </div>
