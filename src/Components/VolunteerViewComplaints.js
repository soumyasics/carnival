...
function VolunteerViewComplaints() {
                    ...
                    <div class="table-responsive" style={{overflowX:'auto'}}>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                            ...
                                            <td>
                                               <Link to={`/volunteer_addcomplaint_status/${a._id}`}> <button class="btn btn-sm btn-danger" >status</button></Link>
                                            </td>
...
export default VolunteerViewComplaints
